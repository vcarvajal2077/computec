    ...
    <main>
      ...
      <section className="main-slider" style={{background: "linear-gradient(135deg, #2563eb 0%, #764ba2 100%)", color: "white", padding: 0}}>
        <div className="slider-container" style={{maxWidth: "1200px", margin: "0 auto", position: "relative", minHeight: "420px", display: "flex", alignItems: "center"}}>
          ...
          <div className="slider-slide active" style={{display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", minHeight: "420px"}}>
            <div className="slider-content" style={{maxWidth: "600px"}}>
              ...
              <a href="#" className="btn btn-primary"><i className="fas fa-tools"></i> Ver Servicios</a>
            </div>
          ...
          <button className="slider-prev" style={{position: "absolute", left: "-3.5rem", top: "45%", transform: "translateY(-50%)", background: "rgba(0,0,0,0.15)", border: "none", borderRadius: "50%", width: "2.5rem", height: "2.5rem", color: "white", fontSize: "1.3rem", cursor: "pointer"}}><i className="fas fa-chevron-left"></i></button>
          <button className="slider-next" style={{position: "absolute", right: "-3.5rem", top: "45%", transform: "translateY(-50%)", background: "rgba(0,0,0,0.15)", border: "none", borderRadius: "50%", width: "2.5rem", height: "2.5rem", color: "white", fontSize: "1.3rem", cursor: "pointer"}}><i className="fas fa-chevron-right"></i></button>
        </div>
        {/* Indicadores */}
        <div className="slider-indicators" style={{display: "flex", justifyContent: "center", gap: "0.7rem", marginTop: "-2.5rem", marginBottom: "2.5rem", position: "relative", zIndex: 2}}>
          <span className="slider-dot active" style={{width: "12px", height: "12px", borderRadius: "50%", background: "#fff", opacity: 0.7, cursor: "pointer"}}></span>
          <span className="slider-dot" style={{width: "12px", height: "12px", borderRadius: "50%", background: "#fff", opacity: 0.4, cursor: "pointer"}}></span>
          <span className="slider-dot" style={{width: "12px", height: "12px", borderRadius: "50%", background: "#fff", opacity: 0.4, cursor: "pointer"}}></span>
        </div>
      </section>
      {/* Features */}
        ...
        <div className="slider-container" style={{maxWidth: "1200px", margin: "0 auto", position: "relative", minHeight: "380px", display: "flex", alignItems: "center"}}>
          <div className="slider-slide active" style={{display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", minHeight: "380px"}}>
            <div className="slider-content" style={{maxWidth: "600px"}}>
              ...
              <a href="#" className="btn btn-primary"><i className="fas fa-tools"></i> Más info</a>
            </div>
            <div className="slider-image" style={{flex: 1, display: "flex", justifyContent: "flex-end"}}>
          ...
          {/* Puedes agregar más slides aquí si deseas el slider completo */}
          <button className="slider-prev" style={{position: "absolute", left: "-3.5rem", top: "45%", transform: "translateY(-50%)", background: "rgba(0,0,0,0.10)", border: "none", borderRadius: "50%", width: "2.5rem", height: "2.5rem", color: "#2563eb", fontSize: "1.3rem", cursor: "pointer"}}><i className="fas fa-chevron-left"></i></button>
          <button className="slider-next" style={{position: "absolute", right: "-3.5rem", top: "45%", transform: "translateY(-50%)", background: "rgba(0,0,0,0.10)", border: "none", borderRadius: "50%", width: "2.5rem", height: "2.5rem", color: "#2563eb", fontSize: "1.3rem", cursor: "pointer"}}><i className="fas fa-chevron-right"></i></button>
        </div>
        <div className="slider-indicators" style={{display: "flex", justifyContent: "center", gap: "0.7rem", marginTop: "-2.5rem", marginBottom: "2.5rem", position: "relative", zIndex: 2}}>
        ...
        <div className="slider-container" style={{maxWidth: "1200px", margin: "0 auto", position: "relative", minHeight: "380px", display: "flex", alignItems: "center"}}>
          <div className="slider-slide active" style={{display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", minHeight: "380px"}}>
            <div className="slider-content" style={{maxWidth: "600px"}}>
              ...
              <a href="#" className="btn btn-primary"><i className="fas fa-laptop"></i> Ver más</a>
            </div>
            <div className="slider-image" style={{flex: 1, display: "flex", justifyContent: "flex-end"}}>
          ...
          <div className="services-grid">
            <div className="service-card">
              ...
              <ul className="service-features">
                <li><i className="fas fa-check"></i> Diagnóstico gratuito</li>
                <li><i className="fas fa-check"></i> Garantía de 3 meses</li>
                <li><i className="fas fa-check"></i> Repuestos originales</li>
                <li><i className="fas fa-check"></i> Servicio a domicilio</li>
              </ul>
            ...
            <div className="service-card featured">
              ...
              <ul className="service-features">
                <li><i className="fas fa-check"></i> Configuración personalizada</li>
                <li><i className="fas fa-check"></i> Componentes de calidad</li>
                <li><i className="fas fa-check"></i> Instalación de software</li>
                <li><i className="fas fa-check"></i> Garantía de 1 año</li>
              </ul>
              <div className="service-price">
            ...
            <div className="service-card">
              ...
              <ul className="service-features">
                <li><i className="fas fa-check"></i> Soporte remoto 24/7</li>
                <li><i className="fas fa-check"></i> Mantenimiento preventivo</li>
                <li><i className="fas fa-check"></i> Instalación de programas</li>
                <li><i className="fas fa-check"></i> Recuperación de datos</li>
              </ul>
              <div className="service-price">
            ...
            <div className="service-card">
              ...
              <ul className="service-features">
                <li><i className="fas fa-check"></i> Instalación de antivirus</li>
                <li><i className="fas fa-check"></i> Configuración de firewall</li>
                <li><i className="fas fa-check"></i> Backup automático</li>
                <li><i className="fas fa-check"></i> Monitoreo de seguridad</li>
              </ul>
              <div className="service-price">
      ...
      {/* Botón de WhatsApp */}
      <a href="https://wa.me/573001234567" className="whatsapp-button" target="_blank">
